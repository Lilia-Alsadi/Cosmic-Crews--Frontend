    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
      <div className="bg-[#0F1428] border border-slate-800 rounded-xl p-6 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-2">
          ...
          <span className="text-4xl font-bold text-white mt-2">1,245</span>
        </div>
      </div>
      ...
      <div className="bg-[#0F1428] border border-slate-800 rounded-xl p-6 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-2">
          ...
          <span className="text-4xl font-bold text-white mt-2">89</span>
        </div>
      </div>
      ...
      <div className="bg-[#0F1428] border border-slate-800 rounded-xl p-6 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-2">
          ...
          <span className="text-4xl font-bold text-white mt-2">4,502</span>
        </div>
      </div>
    </div>
  );
