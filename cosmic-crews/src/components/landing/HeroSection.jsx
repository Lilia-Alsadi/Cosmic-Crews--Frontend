const CosmicIllustration = () => (
  <div className="relative flex items-center justify-center w-full min-h-[350px]">
    ...
    <svg
      ...
      className="w-full max-w-[320px] relative z-10 animate-float-slow"
      aria-label="Crescent moon and telescope illustration"
      role="img"
    >
      <defs>
      ...
      <path
        d="M 70 35 A 40 40 0 1 0 115 80 A 32 32 0 1 1 70 35 Z"
        fill="url(#moonGrad)"
        filter="url(#softGlow)"
      />
...
const HeroSection = () => (
  <section id="hero" className="relative overflow-hidden py-24" aria-labelledby="hero-heading">
    <div
      className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_70%_50%_at_50%_-5%,rgba(124,58,237,0.18),transparent_65%)]"
    />
    ...
    <div className="section-container relative z-10">
      <div className="grid items-center gap-16 grid-cols-2">
        <div className="flex flex-col gap-6">
          <h1
            id="hero-heading"
            className="font-display font-bold text-5xl leading-tight tracking-tight text-white"
          >
            Your Cozy Hub<br />
            Under the{" "}
            <span
          ...
          <p className="text-slate-400 text-lg leading-relaxed max-w-md">
            Keep a personal stargazing journal, check sky conditions, and connect with other observers. Built simply for people who love looking up.
          </p>
          ...
          <div>
            <a
              href="/register"
              id="hero-cta-btn"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full text-white font-semibold text-base bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 shadow-lg hover:shadow-purple-500/25 hover:-translate-y-0.5 transition-all duration-300 group"
            >
              Start Exploring
