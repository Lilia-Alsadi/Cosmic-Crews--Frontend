  ...
  return (
    <header
      ...
      className={`sticky top-0 z-50 w-full backdrop-blur-lg transition-all duration-300 ${
        scrolled
          ? "bg-slate-950/90 border-b border-white/10 shadow-lg shadow-black/40"
      ...
      <div className="section-container grid h-16" style={{ gridTemplateColumns: "1fr auto 1fr" }}>
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <a
            href="/register"
            id="nav-register-btn"
            className="px-4 py-2 text-sm font-semibold text-white rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 shadow-md shadow-purple-900/35 transition-all duration-200"
          >
            Register
          </a>
        </div>
